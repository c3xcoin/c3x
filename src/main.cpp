...
const string strMessageMagic = "Conn3x Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
    ...
    {
        nSubsidy = 155000000 * COIN;   // 155M Premine
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees, int nHeight)
{
	...
	if(pindexBest->nHeight < 129600)
    	nRewardCoinYear = 100 * COIN_YEAR_REWARD; //100%
    else if(pindexBest->nHeight < 259200)
    	nRewardCoinYear = 50 * COIN_YEAR_REWARD; //50%
    else if(pindexBest->nHeight < 385800)
...
#ifdef ENABLE_WALLET
// conn3x: attempt to generate suitable proof-of-stake
...
{
    int64_t ret = blockValue * 0.80; //80% for masternodes
