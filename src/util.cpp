...
int nAnonymizeConn3xAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Conn3x
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Conn3x
    // Mac: ~/Library/Application Support/Conn3x
    // Unix: ~/.conn3x
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Conn3x";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "conn3x.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "c3xd.pid"));
