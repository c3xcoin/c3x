    ...
    nWeight(0)
{
    //resize(970, 570);
	resize(1080, 662);
    setWindowTitle(tr("Conn3x") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("Conn3x");
    setStyleSheet("#Conn3x { background-color: #f9f9f9);  }"
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Conn3x address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Conn3xNodes"), this);
    masternodeManagerAction->setToolTip(tr("Show Conn3xNodes Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About Conn3x"), this);
    aboutAction->setToolTip(tr("Show information about Conn3x"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Conn3x"));
...
void BitcoinGUI::createToolBars()
{
	...
	if (fUseBlackTheme)
    {
		...
		toolbar->setStyleSheet("QToolButton { color: #101010; } QToolButton:hover { background-color: #ffffff } QToolButton:checked { background-color: #ffffff } QToolButton:pressed { background-color: none } #tabs { color: #101010; background-color: #f9f9f9);  }");

		QLabel* header = new QLabel();
		header->setMinimumSize(125, 125);
		header->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
		header->setPixmap(QPixmap(":/icons/bitcoin"));
		header->setMaximumSize(160,160);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Conn3x client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Conn3x client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Conn3x network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Conn3x address or malformed URI parameters."));
    }
