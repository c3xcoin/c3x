...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeConn3xAmount"))
        settings.setValue("nAnonymizeConn3xAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeConn3xAmount = settings.value("nAnonymizeConn3xAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeConn3xAmount"))
        SoftSetArg("-anonymizeConn3xamount", settings.value("nAnonymizeConn3xAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeConn3xAmount:
            nAnonymizeConn3xAmount = value.toInt();
            settings.setValue("nAnonymizeConn3xAmount", nAnonymizeConn3xAmount);
            emit anonymizeConn3xAmountChanged(nAnonymizeConn3xAmount);
            break;
        default:
            break;
        }
